                                ...
                                <div class="item" data-id="2">
                                    <div class="r_t">
                                        <div class="teksta">
                                            ...
                                            <p class="txt_3">
                                                Три изделия: <span>Изделия: на ваш выбор, любой сложности</span>
                                            </p>
                                            <p class="txt_4">
                                ...
                                <div class="item" data-id="3">
                                    <div class="r_t">
                                        <div class="teksta">
                                            ...
                                            <p class="txt_3">
                                                Три изделия: <span>из базового гардероба на выбор</span>
                                            </p>
                                            <p class="txt_4">
                                                Фасоны: <span>простые и средние сложности,на ваш выбор.</span>
                                            </p>
                                            ...
                                            <p class="txt_8">10 практических занятий
                                            <br>по 3 часа каждое</p>
                                            <div class="skidka">
                                                <!--<p class="sk1">8 450 рублей/месяц</p>-->
                                                <p class="sk2">9 900 рублей/месяц</p>
                                            </div>
                                        </div>
