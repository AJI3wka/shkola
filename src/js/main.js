...
$(document).ready(function() {
    ...
    $('.nav a').click(function(e){;
     ...
     if($(this).hasClass('scrollto')){
        e.preventDefault();$("html, body").animate({ scrollTop: $($(this).attr('href')).offset().top-62}, 2000);
     }
 });
  ...
  $('input[name="phone"]').focus(function() {$(this).removeClass('error-input');});
   ...
   slider2 = $('.sec8').find('.slider-wrap').bxSlider({
        infiniteLoop: true,
       // pagerCustom:'.pager',
        controls: true,
        nextSelector:'#arr1r',
   ...
   slider3 = $('.sec4').find('.slider-wrap').bxSlider({
        infiniteLoop: true,
        //pagerCustom:'.pager',
        controls: true, 
        nextSelector:'#arr1r',
   ...
   slider4 = $('.sec8').find('.slider-wrap_otz').bxSlider({
        infiniteLoop: true,
        //pagerCustom:'.pager',
        controls: true,
    ...
    slider5 = $('.sec10').find('.slider-wrap_shmot').bxSlider({
        infiniteLoop: true,
        //pagerCustom:'.pager',
        controls: true,
        nextSelector:'#arr1r_otz',
    ...
    slider6 = $('.sec4').find('.slider-wrap_comm').bxSlider({ 
        infiniteLoop: true,
        //pagerCustom:'.pager',
        controls: true,
