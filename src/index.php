        ...
        <div class="slider-wrap_tbrl">
            ...
            <div class="item" data-id="2">
                <div class="comments">
                    ...
                    <p class="drm_txt">Вас научат, как правильно посадить вещи, чтобы они корректировали фигуру.<br><br> Больше не будет муторного поиска того самого платья. Спустя два месяца вы сами его сошьете.<br><br> Сошьете на себя, по своим меркам, с учетом особенностей фигуры.
                    </p>
            ...
            <div class="item" data-id="5">
                <div class="comments">
                    ...
                    <p class="drm_txt">К нам часто приходят молодые мамы, чтобы почерпнуть вдохновение и освоить новую профессию. <br><br>Спустя два месяца они шьют вещи для себя и своей семьи. Многие признаются, что уроки подарили им второе дыхание.
                    </p>
                </div>
            </div>
            <div class="item" data-id="6">
                ...
                <div class="slider-wrap_comm">
                    ...
                    <div class="item" data-id="2">
                        ...
                        <div class="txt_tm">
                            ...
                            Опыт работы более 20 лет.<br><br>
                            Помимо работы портным Галина Павловна занималась преподаванием в течение 15 лет. За это время она выпустила более 400 портных.<br><br> Принимала участие в конкурсах профессионального мастерства и сопровождала учащихся на городские и региональные конкурсы профмастерства.<br><br>
                            Также занималась индивидуальным пошивом, специализируясь на легкой и верхней женской одежде, мужском гардеробе.<br><br></span>
                    ...
                    <div class="item" data-id="4">
                        ...
                        <div class="txt_tm">
                            <span class="normal_txt">
                            Опыт работы 32 года.<br><br>
                            Нина Валентиновна работала мастером производственного обучения и преподавателем. Постоянно повышает профессиональный уровень и мастерство, сотрудничая с молодежью.<br><br>
                            При аттестации в 2006 году получила высшую квалификационную категорию. Со студентами всегда создавала интересные и сложные коллекции, участвовали в конкурсах молодых дизайнеров и конструкторов-модельеров, фестивалях молодежной моды.<br><br>
                            За активную творческую работу и вклад в воспитание высококвалифицированных специалистов неоднократно награждалась почетными грамотами, благодарственными письмами и дипломами. В 2007 году получила Почетную грамоту Министерства образования и науки РФ.<br><br></span>
                ...
                <div class="slider-wrap_type">
                    ...
                    <div class="item pop_texn">
                        <div class="l_textn">
                            ...
                            <div class="skidka">
                                <p class="sk1">38 680 за весь курс</p>
                                <p class="sk2">32 900 за весь курс</p>
                            </div>
                        </div>
                        <div class="r_textn">
                            <p class="txt_1">
